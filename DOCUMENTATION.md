...
### 3.8 Nuage de points par année de décès — `points_personnalites`

Chaque personnalité morte à 25 ans ou plus se place en $(t, a)$ : année de
décès, âge au décès. Celles qui partagent la même année de décès **et** la même
année de naissance forment un seul point, dont la taille croît avec leur nombre ;
le survol liste les plus connues (6 au plus) avec leur écart à l'âge prédit.
La couleur indique la position par rapport à l'âge prédit (§ 3.7), et un point
formé de décès avant 60 ans, sans âge prédit, est gris.

Deux lignes l'accompagnent (`age_moyen_par_annee_deces`) : l'âge moyen au décès
des personnalités mortes l'année $t$, et celui de l'ensemble des Français morts
la même année, décès à 25 ans ou plus dans les deux cas — le même calcul que
§ 3.6, année par année.

> **Décision** — *Année de décès en abscisse* **plutôt qu'**année de naissance,
> **parce que** chaque année de décès est observée en entier, à tous les âges.
> Par année de naissance, seuls les décès de la période 1990–2024 sont visibles :
> les générations anciennes n'y apparaissent que par leurs grands âges et les
...
**Une partie de l'écart masculin tient aux décès précoces.** Les morts entre 25
et 59 ans pèsent 17 % des décès d'hommes dans la population, contre 8 % chez les
personnalités ; en ne gardant que les décès à 60 ans ou plus, l'écart masculin
...
- **Âge prédit issu d'une table du moment** : il sous-estime la survie réelle.
  ...
  exclues.
- **Morts la même année, pas nés la même année** : les lignes du nuage de points
  comparent des personnes décédées la même année. L'écart mêle donc la longévité
  et la différence de fréquence des décès précoces entre les deux groupes.
